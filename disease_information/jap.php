...
<body>
    <header class="header">
        <div class="header-container">
            <a href="<?php echo $nav_header_link; ?>" class="text-light" id="nav_vaccine">無料の予防接種</a>
            <div class="dropdown">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="multiCollapseExample1">
                            <ul class="navbar-nav">
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_home" href="../home/jap.php">メインページ</a>
                                </li>
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_diseases" href="../disease_information/jap.php">知っておくべき病気。</a>
                                </li>
                                ...
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_review" href="#">商品レビュー</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <ul class="breadcrumbs">
                <li class="breadcrumbs__item">
                    <a href="#" class="breadcrumbs__link">メインページ</a>
                </li>
                <li class="breadcrumbs__item">
                    <a href="#" class="breadcrumbs__link">知っておくべき病気。</a>
                </li>
            </ul>
        </div>
    </div>
    <h2 id="disease_title" style="color: #044374; text-align: center; font-size: 48px;font-style: normal;font-weight: 600;line-height: normal;">知っておくべき病気。</h2>
    ...
    <div class="container text-center">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" id="All" href="../disease_information/jap.php" onclick="changeCategory('全て');">全て</a></li>
                <li><a class="dropdown-item" id="Skin and hair" href="?id_disease=1&lang=jap" onclick="changeCategory('肌と髪');">肌と髪</a></li>
                <li><a class="dropdown-item" id="Eyes" href="?id_disease=2&lang=jap" onclick="changeCategory('目');">目</a></li>
                <li><a class="dropdown-item" id="Brain" href="?id_disease=3&lang=jap" onclick="changeCategory('脳');">脳</a></li>
                <li><a class="dropdown-item" id="Throat" href="?id_disease=4&lang=jap" onclick="changeCategory('喉');">喉</a></li>
                <li><a class="dropdown-item" id="Obstetrics" href="?id_disease=5&lang=jap" onclick="changeCategory('産科医');">産科医</a></li>
                <li><a class="dropdown-item" id="Intestine" href="?id_disease=6&lang=jap" onclick="changeCategory('腸');">腸</a></li>
                <li><a class="dropdown-item" id="Joints" href="?id_disease=7&lang=jap" onclick="changeCategory('関節');">関節</a></li>
                <li><a class="dropdown-item" id="Mouth" href="?id_disease=8&lang=jap" onclick="changeCategory('口腔');">口腔</a></li>
            </ul>
        </div>
        <script>
            window.onload = function() {
                ...
                if (idDisease) {
                    ...
                    switch (idDisease) {
                        case '1':
                            categoryBtn.innerText = '肌と髪';
                            break;
                        case '2':
                            categoryBtn.innerText = '目';
                            break;
                        case '3':
                            categoryBtn.innerText = '脳';
                            break;
                        case '4':
                            categoryBtn.innerText = '喉';
                            break;
                        case '5':
                            categoryBtn.innerText = '産科医';
                            break;
                        case '6':
                            categoryBtn.innerText = '腸';
                            break;
                        case '7':
                            categoryBtn.innerText = '関節';
                            break;
                        case '8':
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            $lang = isset($_GET['lang']) ? $_GET['lang'] : "jap"; 
