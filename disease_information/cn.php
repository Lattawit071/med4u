...
<header class="header">
    <div class="header-container">
      <a href="<?php echo $nav_header_link; ?>" class="text-light" id="nav_vaccine">免费接种疫苗</a>
      <div class="dropdown">
        <button class="dropbtn" id="selectedLanguage">
            <img src="../uploads/lang/china.png" alt="Language" class="flag">CN
        </button>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="multiCollapseExample1">
                            <ul class="navbar-nav">
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_home" href="../home/cn.php">主页</a>
                                </li>
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_diseases" href="../disease_information/cn.php">值得了解的疾病</a>
                                </li>

                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_information" href="article_information?lang=<?php echo $lang ?>">健康资讯</a>
                                </li>

                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_promotion" href="promotion?lang=<?php echo $lang ?>">医院和诊所</a>
                                </li>
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_review" href="review?lang=<?php echo $lang ?>">评论</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div class="container">
      <ul class="breadcrumbs">
        <li class="breadcrumbs__item">
          <a href="#" class="breadcrumbs__link">主页</a>
        </li>
        <li class="breadcrumbs__item">
          <a href="#" class="breadcrumbs__link">值得了解的疾病</a>
        </li>
      </ul>
    </div>
  </div>
  <h2 id="disease_title" style="color: #044374; text-align: center; font-size: 48px;font-style: normal;font-weight: 600;line-height: normal;">值得了解的疾病</h2>
  ...
  <div class="container text-center">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" id="All" href="../disease_information/cn.php" onclick="changeCategory('全部');">全部</a></li>
            <li><a class="dropdown-item" id="Skin and hair" href="?id_disease=1&lang=cn" onclick="changeCategory('皮肤和头发');">皮肤和头发</a></li>
            <li><a class="dropdown-item" id="Eyes" href="?id_disease=2&lang=cn" onclick="changeCategory('眼睛');">眼睛</a></li>
            <li><a class="dropdown-item" id="Brain" href="?id_disease=3&lang=cn" onclick="changeCategory('脑');">脑</a></li>
            <li><a class="dropdown-item" id="Throat" href="?id_disease=4&lang=cn" onclick="changeCategory('喉咙');">喉咙</a></li>
            <li><a class="dropdown-item" id="Obstetrics" href="?id_disease=5&lang=cn" onclick="changeCategory('产科');">产科</a></li>
            <li><a class="dropdown-item" id="Intestine" href="?id_disease=6&lang=cn" onclick="changeCategory('肠道');">肠道</a></li>
            <li><a class="dropdown-item" id="Joints" href="?id_disease=7&lang=cn" onclick="changeCategory('关节');">关节</a></li>
            <li><a class="dropdown-item" id="Mouth" href="?id_disease=8&lang=cn" onclick="changeCategory('口腔');">口腔</a></li>
        </ul>
    </div>
    <script>
        window.onload = function() {
            ...
            if (idDisease) {
                ...
                switch (idDisease) {
                    case '1':
                        categoryBtn.innerText = '皮肤和头发';
                        break;
                    case '2':
                        categoryBtn.innerText = '眼睛';
                        break;
                    case '3':
                        categoryBtn.innerText = '脑';
                        break;
                    case '4':
                        categoryBtn.innerText = '喉咙';
                        break;
                    case '5':
                        categoryBtn.innerText = '产科';
                        break;
                    case '6':
                        categoryBtn.innerText = '肠道';
                        break;
                    case '7':
                        categoryBtn.innerText = '关节';
                        break;
                    case '8':
                        categoryBtn.innerText = '口腔';
                        break;
                    default:
                        break;
                }
  ...
  <div class="container">
    <div class="row justify-content-center">
      ...
      $lang = isset($_GET['lang']) ? $_GET['lang'] : "cn"; // Updated this line
            ...
            <div class="row">
                ...
                <div class="col-6 mt-5">
                    <div style="color: #1162A1;">
                        <a href="#" id="foot_1"> 个⼈信息保护政策</a>|
                        <a href="#" id="foot_2">曲奇饼政策</a>|
                        <a href="#" id="foot_3">使用条款</a>
                    </div>
                </div>
