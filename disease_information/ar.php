...
<body>
    ...
    <h2 id="disease_title" style="color: #044374; text-align: center; font-size: 48px;font-style: normal;font-weight: 600;line-height: normal;">
        شا ئق أمراض</h2>
                                ...
                                <div class="carousel-item <?php echo $actives; ?>">
                                    ...
                                    <div class="col-md-5 d-flex mt-5">
                                            <div class="title" style="justify-content: center;">
                                                ...
                                                <p class="card-title" style="color: black; padding: 8px; margin-left: 20px;"><?php echo $row['review_description']; ?></p>
                                                <a href="../disease_case/ar.php?&title=<?php echo $row['title']; ?>&id=<?php echo $row['id']; ?>" style="margin-left: 400px;">
                                                    قراءة المزيد
                                                </a>
                                                </a>
                                            </div>
    ...
    <ul class="dropdown-menu">
        <li><a class="dropdown-item" id="All" href="../disease_information/ar.php" onclick="changeCategory('All');">الكل</a></li>
        <li><a class="dropdown-item" id="Hair" href="?id_disease=1&lang=ar" onclick="changeCategory(' شعر وجلد');"> شعر وجلد</a></li>
        <li><a class="dropdown-item" id="Eyes" href="?id_disease=2&lang=ar" onclick="changeCategory('عيون');">العيون</a></li>
        <li><a class="dropdown-item" id="Brain" href="?id_disease=3&lang=ar" onclick="changeCategory('دماغ');">الدماغ</a></li>
        <li><a class="dropdown-item" id="Throat" href="?id_disease=4&lang=ar" onclick="changeCategory('حلق');">الحلق</a></li>
        <li><a class="dropdown-item" id="Obstetrics" href="?id_disease=5&lang=ar" onclick="changeCategory('توليد');">التوليد</a></li>
        <li><a class="dropdown-item" id="Intestine" href="?id_disease=6&lang=ar" onclick="changeCategory('الأمعاء');">الأمعاء</a></li>
        <li><a class="dropdown-item" id="Joints" href="?id_disease=7&lang=ar" onclick="changeCategory('المفاصل');">المفاصل</a></li>
        <li><a class="dropdown-item" id="Mouth" href="?id_disease=8&lang=ar" onclick="changeCategory('الفم');">الفم</a></li>
    </ul>
</div>
...
<script>
    window.onload = function() {
        ...
        if (idDisease) {
            ...
            switch (idDisease) {
                case '1':
                    categoryBtn.innerText = 'شعر وجلد';
                    break;
                case '2':
                    categoryBtn.innerText = 'عيون';
                    break;
                case '3':
                    categoryBtn.innerText = 'دماغ';
                    break;
                case '4':
                    categoryBtn.innerText = 'حنجرة';
                    break;
                case '5':
                    categoryBtn.innerText = 'توليد';
                    break;
                case '6':
                    categoryBtn.innerText = 'أمعاء';
                    break;
                case '7':
                    categoryBtn.innerText = 'مفاصل';
                    break;
                case '8':
                    categoryBtn.innerText = 'فم';
                    break;
                default:
                    break;
            }
        ...
        <div class="row justify-content-center">
            ...
            ?>
                <div class="rounded-element-disease_case" style="width: 380px; padding-bottom: 10px;">
                    <div class="card-body">
                    <a href="../disease_case/ar.php?&title=<?php echo $row['title']; ?>&id=<?php echo $row['id']; ?>">
