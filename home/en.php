...
<body>
        ...
        <div class="header-container">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content" id="myDropdown">
                    ...
                    <a href="cn.php"><img src="../uploads/lang/china.png" alt="Language" class="flag">CN</a>
    ...
    <div class="container-fluid" style="background-image:url('../uploads/disease_logo/disease_bg.png')">
        <div class="p-md-5 text-light justify-content-center align-items-center">
            <h2 class="d-flex justify-content-center mt-1 pt-2" id="disease_title" style="color:#FFFFFF;">Interesting Diseases</h2>
            <div class="container">
            ...
            <div class="container">
                <h2 class="d-flex mt-1 pt-3" id="article_title" style="color:#FFFFFF;">Health Tips</h2>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-5 d-flex mt-5">
                                                <div class="title" style="max-width: 500px;">
                                                    ...
                                                    <a id="Read more" href="article_case.php?&tag=article_case&title=<?php echo $row['title']; ?>&tb=article_case&id=<?php echo $row['id']; ?>" style="padding: 10px;">Read more
                                                    </a>
    ...
    <div class="container">
        <div class="p-md-4 text-light justify-content-center align-items-center">
            <h2 class="d-flex justify-content-center mt-1 pt-2" style="color:#0066B2;">Hospital</h2>
            <div class="container">
                ...
                <?php if (count($hospital) > $displayLimit) : ?>
                    <div class="text-center mt-4">
                        <button class="btn btn-outline-primary" id="loadMoreBtn" style="color: black; border-color: #044374; background-color: transparent;" onmouseover="this.style.color='#044374';" onmouseout="this.style.color='black';">See more</button>
