                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="multiCollapseExample1">
                            <ul class="navbar-nav">
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_home" href="index?lang=<?php echo $lang ?>">Home</a>
                                </li>
                                <li class="nav-item hover-underline-animation">
                                    <a class="nav-link" id="nav_diseases" href="disease_information?lang=<?php echo $lang ?>">Interesting Diseases</a>
                                </li>
